          ...
          <main className="workspace-grid-crisp">
            ...
            <section className="ide-explorer-panel crisp-panel">
              ...
              <div className="sidebar-bottom-nav">
                <div className={`sidebar-nav-item ${(explorerView === 'project' || explorerView === 'folder') ? 'active' : ''}`} onClick={() => setExplorerView(prev => prev === 'project' ? 'folder' : 'project')}>
                  <Briefcase className="w-2.5 h-2.5" />
                  <span>PROJECTS</span>
                </div>
                <div className={`sidebar-nav-item ${explorerView === 'builds' ? 'active' : ''}`} onClick={() => setExplorerView(prev => prev === 'builds' ? 'folder' : 'builds')}>
                  <Terminal className="w-2.5 h-2.5" />
                  <span>BUILDS</span>
                </div>
                <div className={`sidebar-nav-item`} onClick={() => navigate('/settings')}>
